...
**Project instructions:** Read ./CLAUDE.md or ./GEMINI.md if exists — follow project-specific guidelines
...
**Project instructions:** Read ./CLAUDE.md or ./GEMINI.md if exists — verify plans honor project guidelines
